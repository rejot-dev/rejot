...
`rejot-cli` requires [Bun](https://bun.sh/) v1.2.8 or higher, and is published to
[npmjs.com](https://www.npmjs.com/package/@rejot-dev/cli).

### NPM

```bash
bun install -g @rejot-dev/cli
