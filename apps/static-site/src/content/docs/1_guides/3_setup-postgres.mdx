...
GRANT USAGE ON SCHEMA rejot_events TO rejot_role;

GRANT USAGE ON SCHEMA rejot_data_store TO rejot_role;

GRANT
SELECT
,
  INSERT,
UPDATE ON ALL TABLES IN SCHEMA rejot_data_store TO rejot_role;

GRANT
SELECT
,
  INSERT,
UPDATE ON ALL TABLES IN SCHEMA rejot_events TO rejot_role;
```
