...
export class MysqlBinlogListener {
  ...
  async start(): Promise<boolean> {
    ...
    try {
      ...
      // The COM_BINLOG_DUMP packet is likely not correctly implemented for newer mysql versions (tested 5.7 and 9.2.0)
      // Seems the binlog stream is not really maintained by mysql2 folks
